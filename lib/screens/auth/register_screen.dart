...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> mostrarDialogoTerminos() async {
      ...
      builder: (BuildContext context) => WillPopScope(
        ...
        child: Dialog(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: BorderSide(
                color: const Color(0xFF06B6D4).withOpacity(0.3), width: 1.5),
          ),
          elevation: 0,
          child: Container(
    ...
    if (aceptado != true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('Debes aceptar los términos para registrarte'),
  ...
  Future<void> registrarUsuario() async {
    ...
    if (primerNombre.isEmpty || primerApellido.isEmpty ||
        fechaNacimiento.isEmpty || gmail.isEmpty ||
    ...
    if (resultado['success'] == true) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(resultado['message'] ?? 'Usuario registrado exitosamente'),
